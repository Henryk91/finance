...
Revision ID: 3522e7c935ff
Revises: 
Create Date: 2025-11-12 15:32:23.874966
...
def upgrade():
    ...
    sa.Column('stock_price', sa.Numeric(precision=15, scale=2), nullable=False),
